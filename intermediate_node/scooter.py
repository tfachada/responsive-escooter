...
def main():
    sender_thread = threading.Thread(target=multicast_sender, args=(SEND_FILE, MCAST_GROUP_B, MCAST_PORT,), daemon=True)
    receiver_thread = threading.Thread(target=multicast_receiver, args=(RECV_OUTPUT_DIR, MCAST_GROUP_A, MCAST_PORT,), daemon=True)
